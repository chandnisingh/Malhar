...
public class JdbcPOJOInputOperator extends AbstractJdbcInputOperator<Object> implements Operator.ActivationListener<Context.OperatorContext>
{
  ...
  public final transient DefaultOutputPort<Object> outputPojo = new DefaultOutputPort<Object>()
  {
    @Override
  ...
  public String queryToRetrieveData()
  {
    ...
    if (limitSupported) {
      ...
      builder.append(" OFFSET ? ROWS FETCH NEXT ? ROWS FETCH NEXT ? ROWS ONLY ");
    }
    builder.append(";");
   ...
   * @useSchema $[].pojoFieldExpression outputPojo.fields[].name
   */
